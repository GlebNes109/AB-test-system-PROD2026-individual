...
from src.api.deps import require_roles, get_events_service
from src.application.events_sevice import EventsService
from src.schemas.events import EventTypesCreate, EventTypesResponse, EventsBatchRequest, EventsBatchResponse
