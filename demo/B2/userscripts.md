...
> **Важно:** из-за механизма охлаждения (cooling period = 1 день) повторная раздача варианта **новому** субъекту, который уже участвует в другом эксперименте, может вернуть default. Поэтому используйте субъектов, которые **не участвовали** в предыдущих экспериментах (уникальные id).
